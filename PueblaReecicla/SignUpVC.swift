...
class SignUpViewController: UIViewController, UITextFieldDelegate {
    ...
    func showActivateAccountAlert(email: String, password: String) {
        ...
        activateAlert.addAction(UIAlertAction(title: "Continuar", style: .default, handler: { [] (_) in
    ...
    @IBAction func goToTerms(_ sender: Any) {
        let termsVC = storyboard?.instantiateViewController(withIdentifier: "Terminos") as? TerminosViewController
        navigationController?.pushViewController(termsVC!, animated: true)
    }
    
    @IBAction func goToPrivacy(_ sender: Any) {
        let privacyVC = storyboard?.instantiateViewController(withIdentifier: "Privacidad") as? PrivacidadViewController
