                                ...
                                if let document = document, document.exists {
                                    if let user = Auth.auth().currentUser{
                                        if user.isEmailVerified{
                                            ...
                                            let alert = UIAlertController(title: "Correo No Verificado", message: "Tu correo no está verificado. Activa tu cuenta para poder acceder a través del correo electrónico que te enviamos cuando te registraste, o bien, podemos enviarte uno nuevo", preferredStyle: .alert)
                                            alert.addAction(UIAlertAction(title: NSLocalizedString("Cancelar", comment: "Default action"), style: .cancel, handler: nil))
                                            alert.addAction(UIAlertAction(title: "Enviar Nuevo Correo", style: .default, handler: { action in
